"""
Program execution and raw output parsing.

run_program()  -- launches the binary and returns (stdout_lines, exit_code)
parse_output() -- maps stdout lines into a ParsedOutput dataclass
"""

import re
import subprocess

from models.bean import ParsedOutput
from consts.const import PROGRAM_FILE
